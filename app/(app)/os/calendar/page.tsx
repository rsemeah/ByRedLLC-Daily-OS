...
export default function OSCalendarPage() {
  ...
  const [dayPopover, setDayPopover] = useState<{ iso: string; events: CalendarEventRow[] } | null>(null)
  ...
  // All authenticated users can create/edit their own events; admins can edit any
  const canEdit = true
